...
<head>
    ...
    <title>Registrar Tipo de Documento | MISCELANEA BEAUTY</title>
...
<div class="container">
    <div class="results-section fade-in">
        ...
        <h3><i class="bi bi-file-earmark-text-fill"></i> Registrar Tipo de Documento</h3>
        ...
        <form action="index.php?action=insertIdtipodocu" method="POST" class="form-grid">
