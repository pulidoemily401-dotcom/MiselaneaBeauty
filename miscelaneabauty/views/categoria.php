...
<head>
    ...
    <title>Registro de Categoría | MISCELANEA BEAUTY</title>
...
<div class="container"> 
    <div class="results-section fade-in">
        ...
        <h3><i class="bi bi-tags-fill"></i> Registro de Categoría</h3>
        ...
        <form action="index.php?action=insertCategoria" method="POST" class="form-grid">
            ...
            <div class="button-group">
                <button type="submit" class="btn btn-primary">
                    <i class="bi bi-floppy-fill"></i> Guardar Categoría
                </button>
