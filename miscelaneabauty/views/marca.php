...
<head>
    ...
    <title>Registro de Marca | MISCELANEA BEAUTY</title>
...
<div class="container">
    <div class="results-section fade-in">
        ...
        <h3><i class="bi bi-award-fill"></i> Registro de Marca</h3>
        ...
        <form action="index.php?action=insertMarca" method="POST" class="form-grid">

            <div class="form-group">
                <label for="marca"><i class="bi bi-award-fill"></i> Nombre de la Marca</label>
            ...
            <div class="button-group">
                <button type="submit" class="btn btn-primary">
                    <i class="bi bi-floppy-fill"></i> Guardar Marca
                </button>
                <a href="index.php?action=listMarca" class="btn btn-back">
