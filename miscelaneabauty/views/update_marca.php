...
<head>
    ...
    <title>Actualizar Marca | MISCELANEA BEAUTY</title>
...
<div class="container">
    <div class="results-section fade-in">
        ...
        <h3><i class="bi bi-pencil-square"></i> Actualizar Marca</h3>
        ...
        <form action="index.php?action=actualizarmarca" method="post" class="form-grid">

            <input type="hidden" name="idmarca" value="<?= htmlspecialchars($marca['idmarca'] ?? ''); ?>">

            <div class="form-group">
                <label for="marca"><i class="bi bi-award-fill"></i> Marca</label>
