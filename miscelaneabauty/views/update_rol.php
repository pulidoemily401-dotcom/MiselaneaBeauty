...
<head>
    ...
    <title>Actualizar Rol | MISCELANEA BEAUTY</title>
...
<div class="container">
    <div class="results-section fade-in">
        ...
        <h3><i class="bi bi-pencil-square"></i> Actualizar Rol</h3>
        ...
        <form action="index.php?action=actualizarrol" method="post" class="form-grid">

            <input type="hidden" name="idrol" value="<?= htmlspecialchars($rol['idrol'] ?? ''); ?>">

            <div class="form-group">
                <label for="nombrerol"><i class="bi bi-shield-fill-check"></i> Nombre del Rol</label>
                <input type="text" name="nombrerol" id="nombrerol" required
                       value="<?= htmlspecialchars($rol['nombrerol'] ?? ''); ?>">
            </div>
            ...
            <div class="button-group">
                ...
                <a href="index.php?action=listRol" class="btn btn-back">
