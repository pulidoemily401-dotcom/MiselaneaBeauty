...
<head>
    ...
    <title>Registrar Rol | MISCELANEA BEAUTY</title>
...
<div class="container">
    <div class="results-section fade-in">
        ...
        <h3><i class="bi bi-person-badge-fill"></i> Registrar Rol</h3>
        ...
        <form action="index.php?action=insertRol" method="POST" class="form-grid">

            <div class="form-group">
                <label for="nombrerol"><i class="bi bi-person-badge"></i> Nombre del Rol</label>
